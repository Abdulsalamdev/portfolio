...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      style={{ paddingTop: "60px", paddingInline: "20px" }}
      className="min-h-screen flex items-center justify-center px-6 sm:px-10 py-24 sm:py-32 bg-[var(--bg)] text-[var(--text)]"
    >
...
<motion.div
  ...
  animate={{ opacity: 1, x: 0, y: [0, -10, 0], scale: 1 }} // gentle floating effect
  transition={{ delay: 0.6, duration: 2, repeat: Infinity, repeatType: "loop" }}
  whileHover={{ scale: 1.05 }} // hover effect
  className="w-48 h-48 sm:w-64 sm:h-64 rounded-full overflow-hidden border-4 border-[var(--accent1)] shadow-[0_0_25px_rgba(138,99,247,0.4)]"
>
  <Image
    src="/profile.jpg"
